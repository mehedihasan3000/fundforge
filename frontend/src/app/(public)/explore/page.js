    ...
    <div className="bg-gray-100 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-4 mb-8 flex flex-wrap gap-3 items-end">
        <div className="flex-1 min-w-50">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full border text-gray-700 border-gray-300 rounded-lg pl-9 pr-3 py-2 text-sm"
              value={search}
        ...
        <div>
          ...
          <select
            className="border text-gray-700 border-gray-300 rounded-lg px-3 py-2 text-sm"
            value={category}
