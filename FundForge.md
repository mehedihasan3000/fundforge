...
This is a modern crowdfunding platform.

You will need to complete this project using Next.js (JavaScript), BetterAuth, Tailwind CSS, Gravity UI Icons, Express.js (JavaScript), MongoDB. Do not use Mongoose.

# **Overview**

The FundForge is designed to let creators raise money for projects, causes, and products by collecting Contributions from Supporters. Supporters browse campaigns, contribute platform credits toward the ones they want to support, and creators withdraw the funds they raise once approved by the platform.
...
The layout for the FundForge will be divided into two primary structures: Basic Layout and Dashboard Layout. The Dashboard layout is described after the 4th requirement.
...
* Join as Developer (this button redirects to client GitHub repository)
...
*(Implement imgBB for uploading Image)*
...
* Select Payment System (dropdown) — Stripe (you need to implement)
...
Clicking a specific card redirects the user to pay a specific amount. Implement a Stripe-based payment system on it. After successful payment:
...
* Use services like SendGrid, Nodemailer or AWS SES for sending emails. I prefer Nodemailer, use Nodemailer to implement this feature.
